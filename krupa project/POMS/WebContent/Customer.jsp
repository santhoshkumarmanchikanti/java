...
<form name="f2" action="CustFun.jsp" method="post">
<div class="card text-white bg-info mb-3">
  <div class="card-header" style="text-align:center"><b>New Customer  Information</b></div>
  <div class="card-body">
  ...
  <div class="row">
  	<div class="col-md-4"></div>
   	<div class="col-md-4">
   		...
   		<input type="text" name="txtCust"  class="form-control"  required/>
   </div>
   <div class="col-md-4"></div> 
   </div>
    ...
    <div class="row">
  	<div class="col-md-4"></div>
   	<div class="col-md-4" style="text-align:center">
   		<br />
   		<input type="submit" value="Add Customer"  class="btn btn-warning"  required/>
