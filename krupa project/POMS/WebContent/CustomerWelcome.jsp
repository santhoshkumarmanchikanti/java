...
<th>Product Name</th><th>Price</th><th>Stock</th><th>Details</th>
</tr>

<%
		
		//int mno= Integer.parseInt(session.getAttribute("mno").toString());
		String sno="",sname="", stk="", pn = "";

	PreparedStatement ps = con.prepareStatement("select prdname, price, stock, pno, manprice from products where manid is not null");
	...
	<td><%=sname %></td>
	<td><%=stk %></td>
	<td><a href="PDetails.jsp?pid=<%=pn %>">Details</a></td>
	</tr>	
<%	
}
%>
